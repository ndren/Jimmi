...
var it = (e, t, o) => t in e ? lt(e, t, {
    enumerable: !0,
    configurable: !0,
    writable: !0,
    value: o
}) : e[t] = o;
var C = (e, t, o) => (it(e, typeof t != "symbol" ? t + "" : t, o), o),
    Ve = (e, t, o) => {
        if (!t.has(e)) throw TypeError("Cannot " + o)
    };
var ge = (e, t, o) => (Ve(e, t, "read from private field"), o ? o.call(e) : t.get(e)),
    he = (e, t, o) => {
        if (t.has(e)) throw TypeError("Cannot add the same private member more than once");
        t instanceof WeakSet ? t.add(e) : t.set(e, o)
    },
    Ee = (e, t, o, r) => (Ve(e, t, "write to private field"), r ? r.call(e, o) : t.set(e, o), o);
import {
    X as Ke,
    m as ct,
    y as ut,
...
class It extends et {
    constructor() {
        ...
        C(this, "commands");
        C(this, "events", {
            [Ce.USER_JOINED]: this.onUserJoined
        });
        C(this, "translations")
    }
    onUserJoined(t) {
...
class $t {
    constructor(t) {
        ...
        he(this, ne, void 0);
        he(this, ae, void 0);
        Ee(this, re, t.videoThumbnails[0].url), Ee(this, ne, t.title), Ee(this, ae, t.adaptiveFormats.filter(o => o.encoding === "opus")[0].url)
    }
    get thumbnailUrl() {
        return ge(this, re)
    }
...
re = new WeakMap, ne = new WeakMap, ae = new WeakMap;
class Ot extends et {
    constructor() {
        super(...arguments);
        C(this, "meta", {
...
!track +10, !track +20, !track -15 - Fast forward or rewind with specific duration in seconds`,
        ...
        C(this, "baseUrl", "https://vid.puffyan.us")
    }
    async fetch(t) {
        return await (await fetch(`${this.baseUrl}/api/v1/${t}`, {
            referrerPolicy: "no-referrer"
        })).json()
    }
    async searchYtVideo(t) {
        if (new RegExp("https?://").test(t)) {
            const o = new URLSearchParams(t.split("?")[1]).get("v");
            if (o) return o;
            const r = t.split("/");
            return r[r.length - 1].split("?")[0]
        } else {
            const o = await this.fetch(`search/?q=${encodeURIComponent(t)}`);
            if (o.length > 0) return o[0].videoId
        }
        return null
    }
    async getTrack(t) {
        const o = await this.fetch(`videos/${t}`);
        return o.error ? null : new $t(o)
    }
    async query(t) {
        const o = t.join(" "),
            r = await this.searchYtVideo(o);
        return r ? this.getTrack(r) : null
    }
    async play(t) {
        if (t.params.length === 0) t.respond(`:warning: ${this.$t("general.invalidArgs")}
${this.$t("commands.play.usage")}`);
        else {
            let o = await this.query(t.params);
            if (!o) {
                t.respond(`${this.$t("general.noVideo")} :worried:`);
                return
            }
            let q = {"source":'https://proxy.cors.sh/' + o.source, "thumbnailUrl":o.thumbnailUrl, "title":o.title}
            this.api.currentTrack = q, this.api.conference.sendMessage(`:notes: ${this.$t("commands.play.playingTrack",{values:{title:o.title}})}`)
        }
    }
    async queue(t) {
        if (t.params.length === 0)
            if (this.api.queue.length === 0) t.respond(`:notes: ${this.$t("commands.queue.isEmpty")}`);
            else {
                let o = 0;
                const r = new RegExp(/(\d)/ig);
                t.respond(this.api.queue.reduce((a, n) => `${a}
${(++o).toString().replaceAll(r,":$1:")} ${n.title}`, `:notes: ${this.$t("commands.queue.content")}`))
            }
        else {
            const o = await this.query(t.params);
            if (!o) {
                t.respond(`${this.$t("general.noVideo")} :worried:`);
                return
            }
            this.api.currentTrack ? this.api.addToQueue(o) : this.api.currentTrack = o, t.respond(`:notes: ${this.$t("commands.queue.addedTrack",{values:{title:o.title}})}`)
        }
    }
    async track(t) {
        var o, r;
        switch (t.params.length) {
            case 0:
                t.respond(`:notes: ${this.$t("commands.track.currentlyPlaying",{values:{title:(r=(o=this.api.currentTrack)==null?void 0:o.title)!=null?r:"nothing"}})}`);
                break;
            case 1:
                const a = t.params[0];
                if (a === "skip") {
                    this.api.currentTrack = void 0;
                    return
                }
                let n = 0;
                const i = p => 2 * Math.E ^ p - 1;
                /^\+\++$/.test(a) ? n = i(a.length) : /^--+$/.test(a) ? n = -i(a.length) : n = parseInt(a, 10), n ? this.api.forward(n) : t.respond(`:warning: ${this.$t("general.invalidArgs")}
${this.$t("commands.track.usage")}`);
                break;
            default:
                t.respond(`:warning: ${this.$t("general.invalidArgs")}
${this.$t("commands.track.usage")}`)
        }
    }
}
...
function tt(e, t) {
    ...
    let o = {};
    return o[e.pop()] = t, tt(e, o)
}
Pe.plugins.forEach(e => {
    const t = new e({});
    t.translations && Object.keys(t.translations).forEach(o => {
        const r = tt(t.meta.id.split("."), t.translations[o]);
        ct(o, {
            plugins: r
        })
    })
});
ut("en", () => Je(() => import("./en.3f1a4bac.js"), []));
...
function Pt(e) {
    let t, o, r, a, n, i, p, m, k, T, h, A;
    const y = e[3].default,
        E = ft(y, e, e[2], null);
    return {
        c() {
            t = c("label"), o = c("div"), r = c("input"), a = g(), n = c("div"), i = g(), p = c("div"), m = g(), k = c("div"), E && E.c(), l(r, "id", "toogleButton"), l(r, "type", "checkbox"), l(r, "class", "hidden svelte-4l3tce"), l(n, "class", "toggle-path bg-gray-200 w-9 h-5 rounded-full shadow-inner svelte-4l3tce"), l(p, "class", "toggle-circle absolute w-3.5 h-3.5 bg-white rounded-full shadow inset-y-0 left-0 svelte-4l3tce"), l(o, "class", "relative"), l(k, "class", "ml-3 text-gray-700 font-medium"), l(t, "class", "flex items-center cursor-pointer")
        },
        m(b, f) {
            v(b, t, f), s(t, o), s(o, r), r.checked = e[0], s(o, a), s(o, n), s(o, i), s(o, p), s(t, m), s(t, k), E && E.m(k, null), T = !0, h || (A = [P(r, "click", function() {
                pt(e[1]) && e[1].apply(this, arguments)
            }), P(r, "change", e[4])], h = !0)
        },
        p(b, [f]) {
            e = b, f & 1 && (r.checked = e[0]), E && E.p && (!T || f & 4) && _t(E, y, e, e[2], T ? ht(y, e[2], f, null) : gt(e[2]), null)
        },
        i(b) {
            T || (j(E, b), T = !0)
        },
...
function Ut(e, t, o) {
    ...
    function p() {
        n = this.checked, o(0, n)
    }
    return e.$$set = m => {
        "checked" in m && o(0, n = m.checked), "onClick" in m && o(1, i = m.onClick), "$$scope" in m && o(2, a = m.$$scope)
    }, [n, i, a, r, p]
}
class Lt extends ee {
    constructor(t) {
...
function Gt(e) {
    let t = e[4]("routes.home.toggleBetaMode") + "",
        o;
    return {
        c() {
            o = S(t)
        ...
        p(r, a) {
            a & 16 && t !== (t = r[4]("routes.home.toggleBetaMode") + "") && I(o, t)
        },
        d(r) {
            r && H(o)
        }
...
function ot(e) {
    let t, o = e[4]("routes.home.domainError") + "",
        r;
    return {
        c() {
            t = c("p"), r = S(o), l(t, "class", "text-xs text-red-500 mt-3")
        },
        m(a, n) {
            v(a, t, n), s(t, r)
        },
        p(a, n) {
            n & 16 && o !== (o = a[4]("routes.home.domainError") + "") && I(r, o)
        },
        d(a) {
            a && H(t)
        }
...
function rt(e) {
    let t, o = e[4]("routes.home.roomError") + "",
        r;
    return {
        c() {
            t = c("p"), r = S(o), l(t, "class", "text-xs text-red-500 mt-3")
        ...
        p(a, n) {
            n & 16 && o !== (o = a[4]("routes.home.roomError") + "") && I(r, o)
        },
        d(a) {
            a && H(t)
        }
...
function vt(e) {
    let t, o, r, a, n = e[4]("routes.home.mainContent.heading") + "",
        i, p, m, k = e[4]("routes.home.mainContent.description") + "",
        T, h, A, y, E, b, f, x, B = e[4]("routes.home.joinRoomHeading") + "",
        z, se, d, U, M = e[4]("routes.home.domainLabel") + "",
        G, Q, N, Ue, Le, L, X, le = e[4]("routes.home.roomLabel") + "",
        Te, Ge, $, ve, He, ie, q, ce, ue = e[4]("general.advancedConfiguration") + "",
        Ae, Me, Z, de = e[4]("general.password") + "",
        ye, qe, O, je, J, me = e[4]("routes.home.joinButtonText") + "",
        Ne, Fe, V, fe = e[4]("routes.home.joinRoomFootnote") + "",
        Se, xe, K, ke, pe, w, we, Be;
...
function Ht(e, t, o) {
    ...
    be(e, Ke, d => o(4, i = d));
    let m = () => {
        window.location.href = r ? "/" : "/beta"
    };
    const k = new RegExp(/^$|^((?:(?:(?:\w[\.\-\+]?)*)\w)+)((?:(?:(?:\w[\.\-\+]?){0,62})\w)+)\.(\w{2,6})$/),
        T = new RegExp(/^[^?&:"'%#]+$/),
        {
            form: h,
            errors: A,
            ...
            validationSchema: bt().shape({
                domain: Oe().trim().matches(k),
                room: Oe().trim().min(1).matches(T).required(),
                password: Oe().optional()
            }),
            onSubmit: d => {
                const U = d.password ? `?password=${d.password}` : "";
                Tt(`/bot/${a}${U}`)
            }
        });
    be(e, h, d => o(0, n = d)), be(e, A, d => o(5, p = d));

    function b(d) {
        if (d instanceof InputEvent && d.data && d.inputType === "insertFromPaste") {
            const {
                data: U
            } = d, M = new RegExp("^http(s?)://(.*)/(.*)$");
            if (!M.test(U)) return;
            const G = M.exec(U);
            if (!(G && G.length >= 4)) return;
            const Q = G[2],
                N = G[3];
            k.test(Q) && T.test(N) && (d.preventDefault(), Xe(h, n.domain = Q, n), Xe(h, n.room = N, n))
        }
    }
    ...
    function B() {
        n.domain = this.value, h.set(n)
    }

    function z() {
        n.room = this.value, h.set(n)
    }

    function se() {
        n.password = this.value, h.set(n)
    }
    return e.$$.update = () => {
        e.$$.dirty & 1 && o(2, a = `${n.domain||"meet.jit.si"}/${n.room}`)
    }, o(3, r = window.location.href.split("/")[3].startsWith("beta")), [n, m, a, r, i, p, h, A, y, E, b, f, x, B, z, se]
}
class Mt extends ee {
    constructor(t) {
        super();
...
function qt(e) {
    ...
    return {
        c() {
            t = c("p"), t.textContent = "404 - Not found"
        },
        m(o, r) {
            v(o, t, r)
        },
...
class jt extends ee {
    constructor(t) {
        super();
        te(this, t, null, qt, oe, {})
    }
}

function Ft(e) {
    let t, o, r, a, n, i, p, m, k, T, h, A, y, E;
    return {
        c() {
            t = c("footer"), o = c("div"), r = c("div"), a = c("div"), n = c("a"), i = S("JIMMI"), p = g(), m = c("p"), m.textContent = "Still under heavy development", k = g(), T = c("div"), h = c("p"), A = S(`Fork me on
          `), y = c("a"), E = S("GitHub"), l(n, "href", Pe.url), l(n, "class", "ml-3 text-xl"), l(m, "class", "text-sm text-gray-500 ml-4 pl-4 border-l-2 border-gray-200 sm:py-2 sm:mt-0"), l(a, "class", "flex items-center md:justify-start justify-center text-gray-900"), l(y, "href", Pe.repoUrl), l(y, "class", "text-indigo-500 ml-1"), l(y, "target", "_blank"), l(y, "rel", "noopener noreferrer"), l(h, "class", "text-sm text-gray-500"), l(T, "class", "sm:ml-auto sm:py-2 sm:mt-0 mt-4 sm:text-left text-center text-gray-500 text-sm"), l(r, "class", "container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row"), l(o, "class", "bg-gray-100 "), l(t, "class", "text-gray-600 body-font absolute bottom-0 w-screen")
        },
        m(b, f) {
            v(b, t, f), s(t, o), s(o, r), s(r, a), s(a, n), s(n, i), s(a, p), s(a, m), s(r, k), s(r, T), s(T, h), s(h, A), s(h, y), s(y, E)
        },
        p: F,
        i: F,
        o: F,
...
function Bt(e) {
    let t, o, r, a, n = !e[0] && nt(e);
    return r = new xt({}), {
        c() {
            t = c("main"), n && n.c(), o = g(), De(r.$$.fragment), l(t, "class", "h-screen")
        },
        m(i, p) {
            v(i, t, p), n && n.m(t, null), s(t, o), Ie(r, t, null), a = !0
        },
        p(i, [p]) {
            i[0] ? n && (St(), Y(n, 1, 1, () => {
                n = null
            }), At()) : n ? (n.p(i, p), p & 1 && j(n, 1)) : (n = nt(i), n.c(), j(n, 1), n.m(t, o))
        },
        i(i) {
            a || (j(n), j(r.$$.fragment, i), a = !0)
        },
        o(i) {
            Y(n), Y(r.$$.fragment, i), a = !1
        },
        d(i) {
            i && H(t), n && n.d(), $e(r)
        }
...
function Vt(e, t, o) {
    let r;
    be(e, kt, n => o(0, r = n)), Ct();
    const a = {
        "/": Mt,
        "/bot/:instance/:room": yt({
            asyncComponent: () => Je(() => import("./Bot.b44f6b2d.js"), ["assets/Bot.b44f6b2d.js", "assets/Bot.7961fba8.css", "assets/vendor.89e2b59b.js"])
        }),
        "*": jt
    };
    return [r, a]
